  ...
  return (
    <div className="main_blog">
      <div className="container">
       <LightGallery class="lightgallery" plugins={[lgZoom, lgAutoplay, lgShare, lgRotate]}>
          <a href={Picture} className="lightgallery_link"> 
          <img src={Picture} className="lightgallery_img"/>
        </a> 
        </LightGallery> 
